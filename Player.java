...
/**
 * Creates the class for the player. It has all the attributes a player should
 * hold.
 *
 */
public class Player {
    ...
    /**
     * @constructor @param (x): x position of the player
    ...
    /**
     * @public changes the health, reload speed, and movement speed of the
     * player based on what upgrades they bought
