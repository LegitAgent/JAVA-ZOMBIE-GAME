...
public class GameCanvas extends JComponent {
     ...
     *
     * @param f gets an input JFrame to use as a medium to where all of the
     * things will be drawn.
     */
    public GameCanvas(JFrame f) {
        ...
        /**
         * lineH = new Line2D.Double(0,300,800,300); lineV = new
         * Line2D.Double(400,0,400,600);
         */
    }
     ...
     *
     * @param pixelsWalked the amount of pixels walked by the player and updates
     * the animation by some interval.
     ...
     *
     * @param arr array of bullets to be copied over to the bulletScreen array
     * list.
     */
    ...
    /**
     * Updates the trajectory of the enemies, to ensure that it follows the
     * players around.
     *
     * @param singlePlayer if it is singleplayer gamemode
     * @param sideDead if the side player is dead
     * @param playerID the ID of the player, to know which of the players is the
     * side player relative to it's ID.
     */
    ...
    /**
     * checks the enemy that was damaged, and deducts the health of the enemies
     * based on the damage of the bullet it got hit by.
     */
    ...
    /**
     * checks if the side bullet collided with an enemy, deletes the bullet if
     * true.
     */
