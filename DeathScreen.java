...
/**
 * Creates the class for the death screen. It implements the action listener
 * class.
*
 */
public class DeathScreen implements ActionListener {
    ...
    /**
     * @constructor @param (f): is the frame where the death screen is shown
...
*
    ...
    /**
     * @public displays the death screen when the player dies, adds a quit
     * button to close the java application
*
     */
