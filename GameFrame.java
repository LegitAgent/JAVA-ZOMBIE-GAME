...
/**
 * The GameFrame is where the calculations for the server and input handling are
 * handled.
 */
public class GameFrame extends JFrame implements ActionListener {
    ...
    /**
     * Constructor for GameFrame, initializes variables and componnets to be
     * used.
     */
    public GameFrame() {
        frame = new JFrame();
    ...
    /**
     * Sets up the GUI to be used by the GameFrame, this is where the players
     * are set as well as where the timer starts.
     */
